...
/// Responsive size value used by layout conversion.
...
impl Dimension {
    ...
    pub fn as_px(self) -> Option<f32> {
        match self {
            ...
            Self::Percent(_) | Self::Auto | Self::Fill => None,
        }
    }
}
...
/// Explicit sizing contract for layout dimensions and constraints.
#[derive(Debug, Clone, Copy, PartialEq, Default)]
...
impl Style {
    ...
    pub fn set_width_dimension(&mut self, dimension: impl Into<Dimension>) {
        let dimension = dimension.into();
        self.width = dimension.as_px();
        self.dimensions.width = Some(dimension);
    }

    pub fn set_height_dimension(&mut self, dimension: impl Into<Dimension>) {
        let dimension = dimension.into();
        self.height = dimension.as_px();
        self.dimensions.height = Some(dimension);
    }

    pub fn set_min_width_dimension(&mut self, dimension: impl Into<Dimension>) {
        let dimension = dimension.into();
        self.min_width = dimension.as_px();
        self.dimensions.min_width = Some(dimension);
    }

    pub fn set_min_height_dimension(&mut self, dimension: impl Into<Dimension>) {
        let dimension = dimension.into();
        self.min_height = dimension.as_px();
        self.dimensions.min_height = Some(dimension);
    }

    pub fn set_max_width_dimension(&mut self, dimension: impl Into<Dimension>) {
        let dimension = dimension.into();
        self.max_width = dimension.as_px();
        self.dimensions.max_width = Some(dimension);
    }

    pub fn set_max_height_dimension(&mut self, dimension: impl Into<Dimension>) {
        let dimension = dimension.into();
        self.max_height = dimension.as_px();
        self.dimensions.max_height = Some(dimension);
    }
}
