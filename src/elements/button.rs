        ...
        let (bg, text_color, border) = match self.variant {
            ButtonVariant::Primary => {
                if self.state.disabled {
                    (
                        Color::hex(0x6366f1).with_alpha(0.5),
            ...
            ButtonVariant::Secondary => {
                if self.state.disabled {
                    (
                        Color::hex(0x374151).with_alpha(0.5),
                        Color::WHITE.with_alpha(0.5),
                        Color::TRANSPARENT,
                    )
                } else if self.state.pressed {
            ...
            ButtonVariant::Outline => {
                if self.state.disabled {
                    ...
                    (
                        Color::hex(0x6366f1).with_alpha(0.1),
                        Color::hex(0x4338ca),
                        Color::hex(0x4338ca),
                    )
                } else if self.state.hovered {
                    (
                        Color::hex(0x6366f1).with_alpha(0.05),
                        Color::hex(0x4f46e5),
                        Color::hex(0x4f46e5),
                    )
                } else {
            ...
            ButtonVariant::Ghost => {
                if self.state.disabled {
                    (
                        Color::TRANSPARENT,
                        Color::hex(0x6b7280).with_alpha(0.5),
                        Color::TRANSPARENT,
                    )
                } else if self.state.pressed {
                    (
                        Color::hex(0x6b7280).with_alpha(0.2),
                        Color::hex(0x374151),
                        Color::TRANSPARENT,
                    )
                } else if self.state.hovered {
                    (
                        Color::hex(0x6b7280).with_alpha(0.1),
                        Color::hex(0x4b5563),
                        Color::TRANSPARENT,
                    )
                } else {
            ...
            ButtonVariant::Danger => {
                if self.state.disabled {
                    (
                        Color::hex(0xef4444).with_alpha(0.5),
                        Color::WHITE.with_alpha(0.5),
                        Color::TRANSPARENT,
                    )
                } else if self.state.pressed {
            ...
            ButtonVariant::Success => {
                if self.state.disabled {
                    (
                        Color::hex(0x22c55e).with_alpha(0.5),
                        Color::WHITE.with_alpha(0.5),
                        Color::TRANSPARENT,
                    )
                } else if self.state.pressed {
...
impl Element for Button {
    ...
    fn layout(&mut self, cx: &mut LayoutContext) -> NodeId {
        ...
        let node = match cx.taffy.new_leaf(style) {
            Ok(node) => node,
            Err(err) => panic!("Failed to create button layout node: {err}"),
        };
